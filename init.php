...
require_once $abs_us_root.$us_url_root.'helpers/helpers.php';
...
require_once $abs_us_root.$us_url_root.'classes/Cookie.php';
require_once $abs_us_root.$us_url_root.'classes/DB.php';
require_once $abs_us_root.$us_url_root.'classes/Hash.php';
require_once $abs_us_root.$us_url_root.'classes/Input.php';
require_once $abs_us_root.$us_url_root.'classes/Redirect.php';
require_once $abs_us_root.$us_url_root.'classes/Session.php';
require_once $abs_us_root.$us_url_root.'classes/Token.php';
require_once $abs_us_root.$us_url_root.'classes/User.php';
require_once $abs_us_root.$us_url_root.'classes/Validate.php';
require_once $abs_us_root.$us_url_root.'classes/phpmailer/PHPMailerAutoload.php';
